...
namespace HiddenBull.UrpStyle
{
    ...
    {
        [Tooltip("How much of the sky the clouds take up. 0 is a clear sky and 1 is fully " +
                 "overcast, with the sky filling in one piece at a time in between. The Cloud Atlas " +
                 "Generator previews the same threshold, so a value checked there looks the same " +
                 "here. Needs a cloud atlas on the renderer feature.")]
        public ClampedFloatParameter coverage = new ClampedFloatParameter(0.475f, 0f, 1f);
        ...
        public ClampedFloatParameter scale = new ClampedFloatParameter(0.815f, 0.25f, 2f);
        ...
        public ClampedFloatParameter softness = new ClampedFloatParameter(0.125f, 0.01f, 1f);
        ...
        public ClampedFloatParameter stepSpacing = new ClampedFloatParameter(0.125f, 0f, 1f);
        ...
        [Tooltip("How much shading the cloud takes at all: light absorbed on the way down through " +
                 ...
                 "evenly lit.")]
        public ClampedFloatParameter stepShading = new ClampedFloatParameter(0.225f, 0f, 1f);
        ...
        public ClampedFloatParameter stepTaper = new ClampedFloatParameter(0.563f, 0f, 1f);
